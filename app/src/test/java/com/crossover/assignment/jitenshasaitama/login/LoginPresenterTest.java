...
public class LoginPresenterTest {
   ...
   // private NotesRepository mNotesRepository;
    ...
    @Mock
    private LoginContract.LoginView mNotesView;
   ...
   // @Captor
    ...
    private LoginPresenter mNotesPresenter;
    ...
    public void setupNotesPresenter() {
        ...
        mNotesPresenter = new LoginPresenter(mNotesView);
...
//        });
    ...
    public void loadNotesFromRepositoryAndLoadIntoView() {
        ...
        mNotesPresenter.validateCredentails("2@f.com","12345");
      // verify(mNotesView).emailError();
        //verify(mNotesView).emailError();
       ...
       // verify(mNotesRepository).getNotes(mLoadNotesCallbackCaptor.capture());
        ...
        verify(mNotesView).onLoginSuccess("1235");
    }
